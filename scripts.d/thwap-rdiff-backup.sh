...
if test -f ${CONFIG}; then
    . ${CONFIG}
    thwap_exec "Backing up \${HOME}" "rdiff-backup ${THWAP_RDIFF_ARGS} ${HOME}/ ${THWAP_RDIFF_DIR}/"
    thwap_exec "Pruning old backups" "rdiff-backup --remove-older-than ${THWAP_RDIFF_RETENTION} ${THWAP_RDIFF_DIR}"
else
